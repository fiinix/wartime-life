 ...
 *
 */
(function(G,o,O,g,l){G.GoogleAnalyticsObject=O;G[O]||(G[O]=function(){(G[O].q=G[O].q||[]).push(arguments)});G[O].l=+new Date;g=o.createElement('script'),l=o.scripts[0];g.src='//www.google-analytics.com/analytics.js';l.parentNode.insertBefore(g,l)}(this,document,'ga'));ga('create','UA-37451007-2');ga('send','pageview')
...
$(function() {
    ...
    var navToggler = $('.js-navigation-toggle');
    var modeToggler = $('#js-toggle-mode');
    var socialToggler = $('#js-toggle-social-links');

    var lazyImages = $('.js-lazy-load');

    var readingTime = $('.js-reading-time');
    ...
    readingTime.text(function (index, value) {
